        ...
        beforeEnter(el) {
          ...
          while (count--) {
            ...
            if (ball.show) {
              ...
              let x = rect.left - 32; // 计算X坐标
              let y = -(window.innerHeight - rect.top - 22); // 计算Y坐标
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .shopcart
    ...
    .shopcart-list
      ...
      .list-content
        padding: 0 18px
        max-height: 217px // 设定最大高度
        overflow: hidden // 达到最大高度时，隐藏
        background: #fff
        .food
          position: relative
          padding: 12px 0
  ...
  .list-mask
    ...
    height: 100%
    z-index: 40
    backdrop-filter: blur(10px) // iphone上模糊效果
    &.fade-transition
      transition: all 0.5s
      opacity: 1
